...
I continue to see GIS as a tool--it is the interface that allows a researcher to engage in the scientific process of uncovering statistically significant spatial patterns, identifying landscape change, or inspecting gentrification across a city. 

I think that critical GIS studies are expanding the field of GIS into a science of its own right, but the systems themselves are only a science if the data, scientist, and conclusions adhere to conventions of scientific principles. 
...
As someone who comes from a humanities background, I feel concerned and defensive when GIS is lumped in as a science or only deployed in so-called scientific applications. I appreciated the note that Wright made about how the sciences & its constituent language become a magnet for critical funding. It's disappointing to see GIS be reduced to solely a science that's applied for profit rather than a tool that can be used for social change outside of the scientific process. 